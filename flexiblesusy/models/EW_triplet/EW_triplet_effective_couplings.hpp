...
#ifndef EW_triplet_EFFECTIVE_COUPLINGS_H
#define EW_triplet_EFFECTIVE_COUPLINGS_H
...
class EW_triplet_effective_couplings {
public:
   EW_triplet_effective_couplings(const EW_triplet_mass_eigenstates&,
   ...
   void set_model(const EW_triplet_mass_eigenstates& model_);
