...
// File generated at Thu 24 Aug 2017 11:18:19
 ...
 */
double EW_triplet_susy_parameters::calc_beta_LamH_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double EW_triplet_susy_parameters::calc_beta_LamH_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_LamH = Re(twoLoop*(-1.7055*Power(g1,6) + 15.0625*Power(g2,6) -
      312*Power(LamH,3) - 3*LamH*traceYdAdjYdYdAdjYd + 30*
      ...
      traceYeAdjYeYeAdjYeYeAdjYe + 0.125*Power(g2,4)*(7*LamH - 6*(3*
      ...
      traceYeAdjYe*Sqr(LamH) - 144*traceYuAdjYu*Sqr(LamH) - 0.0125*Sqr(g1)*(353
 ...
 */
double EW_triplet_susy_parameters::calc_beta_LamH_three_loop(const Susy_traces& susy_traces) const
{
