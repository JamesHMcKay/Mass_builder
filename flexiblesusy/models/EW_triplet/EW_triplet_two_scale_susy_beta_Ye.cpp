 ...
 */
Eigen::Matrix<double,3,3> EW_triplet_susy_parameters::calc_beta_Ye_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> EW_triplet_susy_parameters::calc_beta_Ye_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Ye = (twoLoop*(0.005*Ye*(1371*Power(g1,4) + 5*Sqr(g1)*(25*
      traceYdAdjYd + 75*traceYeAdjYe + 85*traceYuAdjYu + 54*Sqr(g2)) - 25*(38*
 ...
 */
Eigen::Matrix<double,3,3> EW_triplet_susy_parameters::calc_beta_Ye_three_loop(const Susy_traces& susy_traces) const
{
