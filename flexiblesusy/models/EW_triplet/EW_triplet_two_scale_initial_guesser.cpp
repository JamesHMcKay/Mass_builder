...
EW_triplet_initial_guesser<Two_scale>::EW_triplet_initial_guesser(
   EW_triplet<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const EW_triplet_low_scale_constraint<Two_scale>& low_constraint_,
   const EW_triplet_susy_scale_constraint<Two_scale>& susy_constraint_,
   const EW_triplet_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "EW_triplet_initial_guesser: Error: pointer to model"
          " EW_triplet<Two_scale> must not be zero");
}
 ...
 */
void EW_triplet_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void EW_triplet_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void EW_triplet_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void EW_triplet_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void EW_triplet_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void EW_triplet_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void EW_triplet_initial_guesser<Two_scale>::guess_soft_parameters()
{
