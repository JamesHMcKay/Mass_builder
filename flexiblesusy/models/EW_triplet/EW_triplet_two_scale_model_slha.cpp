 ...
 * @brief EW_triplet model class wrapper for SLHA conversion
 */
...
#define CLASSNAME EW_triplet_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::EW_triplet_slha(const EW_triplet_input_parameters& input_)
   : EW_triplet<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::EW_triplet_slha(const EW_triplet<Two_scale>& model_,
...
CLASSNAME::~EW_triplet_slha()
{
}

void CLASSNAME::clear()
{
   EW_triplet<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   EW_triplet<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const EW_triplet_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

EW_triplet_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   EW_triplet<Two_scale>::print(ostr);
