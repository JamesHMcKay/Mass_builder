...
// File generated at Thu 24 Aug 2017 11:18:23
...
char const * const EW_triplet_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
   { "gauge", "Yu", "Yd", "Ye", "SM", "HMIX" }
;

EW_triplet_slha_io::EW_triplet_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void EW_triplet_slha_io::clear()
{
   slha_io.clear();
}

void EW_triplet_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void EW_triplet_slha_io::set_extpar(const EW_triplet_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void EW_triplet_slha_io::set_minpar(const EW_triplet_input_parameters& input)
{
   std::ostringstream minpar;

   minpar << "Block MINPAR\n";
   minpar << FORMAT_ELEMENT(1, input.HiggsIN, "HiggsIN");
   minpar << FORMAT_ELEMENT(2, input.YcIN, "YcIN");
 ...
 */
void EW_triplet_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void EW_triplet_slha_io::set_spinfo(const Problems<EW_triplet_info::NUMBER_OF_PARTICLES>& problems)
{
 ...
 */
void EW_triplet_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, EW_triplet_info::model_name)
 ...
 */
void EW_triplet_slha_io::set_mass(const EW_triplet_physical& physical,
                                   bool write_sm_masses)
{
   ...
   mass << "Block MASS\n"
      ...
      << FORMAT_MASS(1000001, LOCALPHYSICAL(MFc), "Fc")
      << FORMAT_MASS(1000002, LOCALPHYSICAL(MFn), "Fn")
   ;
 ...
 */
void EW_triplet_slha_io::set_mixing_matrices(const EW_triplet_physical& physical,
...
void EW_triplet_slha_io::set_ckm(
...
void EW_triplet_slha_io::set_pmns(
 ...
 */
void EW_triplet_slha_io::write_to(const std::string& output)
{
   if (output == "-")
 ...
 */
double EW_triplet_slha_io::get_parameter_output_scale() const
{
 ...
 */
void EW_triplet_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void EW_triplet_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void EW_triplet_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void EW_triplet_slha_io::fill(EW_triplet_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&EW_triplet_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&EW_triplet_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
 ...
 */
void EW_triplet_slha_io::fill_drbar_parameters(EW_triplet_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void EW_triplet_slha_io::fill(EW_triplet_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   EW_triplet_physical physical_hk;
 ...
 */
void EW_triplet_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void EW_triplet_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void EW_triplet_slha_io::fill_minpar_tuple(EW_triplet_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
   case 1: input.HiggsIN = value; break;
   case 2: input.YcIN = value; break;
   default: WARNING("Unrecognized entry in block MINPAR: " << key); break;
   }

}

void EW_triplet_slha_io::fill_extpar_tuple(EW_triplet_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void EW_triplet_slha_io::fill_physical(EW_triplet_physical& physical) const
{
   {
   ...
   LOCALPHYSICAL(MFc) = slha_io.read_entry("MASS", 1000001);
   LOCALPHYSICAL(MFn) = slha_io.read_entry("MASS", 1000002);
 ...
 */
double EW_triplet_slha_io::read_scale() const
{
   double scale = 0.;
