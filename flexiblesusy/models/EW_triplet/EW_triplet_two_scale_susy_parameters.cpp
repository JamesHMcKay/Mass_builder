...
// File generated at Wed 15 Nov 2017 19:56:09
...
#define CLASSNAME EW_triplet_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES() calc_susy_traces(TRACE_STRUCT);

const int EW_triplet_susy_parameters::numberOfParameters;

EW_triplet_susy_parameters::EW_triplet_susy_parameters(const EW_triplet_input_parameters& input_)
   : Beta_function()
...
EW_triplet_susy_parameters::EW_triplet_susy_parameters(
   double scale_, unsigned loops_, unsigned thresholds_,
   const EW_triplet_input_parameters& input_
...
Eigen::ArrayXd EW_triplet_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

EW_triplet_susy_parameters EW_triplet_susy_parameters::calc_beta() const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   return EW_triplet_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
                    beta_g1, beta_g2, beta_g3, beta_LamH, beta_Yu, beta_Yd, beta_Ye);
}

EW_triplet_susy_parameters EW_triplet_susy_parameters::calc_beta(unsigned loops) const
{
   EW_triplet_susy_parameters p(*this);
   p.set_loops(loops);

   return p.calc_beta();
}

void EW_triplet_susy_parameters::clear()
{
   reset();
   g1 = 0.;
   g2 = 0.;
...
Eigen::ArrayXd EW_triplet_susy_parameters::get() const
{
...
void EW_triplet_susy_parameters::print(std::ostream& ostr) const
{
...
void EW_triplet_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const EW_triplet_input_parameters& EW_triplet_susy_parameters::get_input() const
{
   return input;
}

EW_triplet_input_parameters& EW_triplet_susy_parameters::get_input()
{
   return input;
}

void EW_triplet_susy_parameters::set_input_parameters(const EW_triplet_input_parameters& input_)
{
   input = input_;
}

void EW_triplet_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const EW_triplet_susy_parameters& susy_pars)
{
