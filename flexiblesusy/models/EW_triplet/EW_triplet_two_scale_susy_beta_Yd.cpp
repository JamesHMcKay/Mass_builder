...
// File generated at Thu 24 Aug 2017 11:18:20
 ...
 */
Eigen::Matrix<double,3,3> EW_triplet_susy_parameters::calc_beta_Yd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> EW_triplet_susy_parameters::calc_beta_Yd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Yd = (twoLoop*(-0.0016666666666666668*Yd*(127*Power(g1,4) + 5*Sqr
      ...
      g2) - 248*Sqr(g3)) + 75*(38*Power(g2,4) - 3*Sqr(g2)*(5*(3*traceYdAdjYd +
      ...
      Sqr(LamH))))) + 0.0125*(187*Sqr(g1) + 5*(135*Sqr(g2) + 4*(-3*(16*LamH + 9
 ...
 */
Eigen::Matrix<double,3,3> EW_triplet_susy_parameters::calc_beta_Yd_three_loop(const Susy_traces& susy_traces) const
{
