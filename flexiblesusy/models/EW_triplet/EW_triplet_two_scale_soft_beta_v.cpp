 ...
 */
double EW_triplet_soft_parameters::calc_beta_v_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double EW_triplet_soft_parameters::calc_beta_v_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_v = Re(-0.00125*twoLoop*v*(1221*Power(g1,4) + 10*Sqr(g1)*(122*
      ...
      299*Power(g2,4) - 108*(3*traceYdAdjYd + traceYeAdjYe + 3*traceYuAdjYu)*
      Sqr(g2) - 8*(-3*(9*traceYdAdjYdYdAdjYd - 2*traceYdAdjYuYuAdjYd + 3*
 ...
 */
double EW_triplet_soft_parameters::calc_beta_v_three_loop(const Soft_traces& soft_traces) const
{
