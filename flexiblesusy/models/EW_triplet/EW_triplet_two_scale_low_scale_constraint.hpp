...
#ifndef EW_triplet_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define EW_triplet_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "EW_triplet_low_scale_constraint.hpp"
...
template<>
class EW_triplet_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   EW_triplet_low_scale_constraint();
   EW_triplet_low_scale_constraint(EW_triplet<Two_scale>*, const softsusy::QedQcd&);
   virtual ~EW_triplet_low_scale_constraint();
   virtual void apply();
