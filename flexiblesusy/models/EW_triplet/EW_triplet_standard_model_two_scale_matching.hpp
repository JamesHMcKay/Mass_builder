...
#ifndef EW_triplet_TWO_SCALE_MATCHING_H
#define EW_triplet_TWO_SCALE_MATCHING_H
...
template <class T> class EW_triplet;
template <class T> class EW_triplet_standard_model_Matching;
...
template<>
class EW_triplet_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   EW_triplet_standard_model_Matching();

   EW_triplet_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       EW_triplet<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~EW_triplet_standard_model_Matching();
