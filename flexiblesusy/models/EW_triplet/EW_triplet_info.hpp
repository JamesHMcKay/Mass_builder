...
#ifndef EW_triplet_INFO_H
#define EW_triplet_INFO_H

#include <iosfwd>

namespace flexiblesusy {

namespace EW_triplet_info {
   enum Particles : unsigned {VG, Hp, Fv, Fc, Fn, Ah, hh, Fd, Fu, Fe, VWp, VP,
      VZ, NUMBER_OF_PARTICLES};

   enum Masses : unsigned {MVG, MHp, MFv_1, MFv_2, MFv_3, MFc, MFn, MAh, Mhh,
      MFd_1, MFd_2, MFd_3, MFu_1, MFu_2, MFu_3, MFe_1, MFe_2, MFe_3, MVWp, MVP,
      MVZ, NUMBER_OF_MASSES};

   enum Parameters : unsigned {g1, g2, g3, LamH, Yu0_0, Yu0_1, Yu0_2, Yu1_0,
      ...
      , Ye2_2, Yc, mu2, v, NUMBER_OF_PARAMETERS};
   ...
   enum Input_parameters : unsigned {HiggsIN, YcIN, Qin, QEWSB,
