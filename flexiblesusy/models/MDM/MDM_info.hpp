...
namespace MDM_info {
   enum Particles : unsigned {VG, Hp, Fv, Fc, Fg, Fn, Ah, hh, Fd, Fu, Fe, VWp,
      VP, VZ, NUMBER_OF_PARTICLES};

   enum Masses : unsigned {MVG, MHp, MFv_1, MFv_2, MFv_3, MFc, MFg, MFn, MAh,
      Mhh, MFd_1, MFd_2, MFd_3, MFu_1, MFu_2, MFu_3, MFe_1, MFe_2, MFe_3, MVWp,
