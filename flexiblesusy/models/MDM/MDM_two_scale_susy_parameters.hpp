...
// File generated at Fri 13 Oct 2017 19:49:24

#ifndef MDM_TWO_SCALE_susy_parameters_H
#define MDM_TWO_SCALE_susy_parameters_H
...
class MDM_susy_parameters : public Beta_function {
public:
   explicit MDM_susy_parameters(const MDM_input_parameters& input_ = MDM_input_parameters());
   MDM_susy_parameters(double scale_, unsigned loops_, unsigned thresholds_, const MDM_input_parameters& input_, double g1_, double g2_, double g3_, double LamH_, const Eigen::Matrix<
   double,3,3>& Yu_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<
   double,3,3>& Ye_
);
   virtual ~MDM_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);
   const MDM_input_parameters& get_input() const;
   MDM_input_parameters& get_input();
   void set_input_parameters(const MDM_input_parameters&);

   MDM_susy_parameters calc_beta() const;
   MDM_susy_parameters calc_beta(unsigned) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MDM_susy_parameters&);
