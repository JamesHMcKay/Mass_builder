...
MDM_soft_parameters MDM_soft_parameters::calc_beta() const
{
   ...
   const MDM_susy_parameters susy_betas(MDM_susy_parameters::calc_beta());

   return MDM_soft_parameters(susy_betas, beta_Yc, beta_mu2, beta_v);
}

MDM_soft_parameters MDM_soft_parameters::calc_beta(unsigned loops) const
{
   MDM_soft_parameters p(*this);
   p.set_loops(loops);
...
void MDM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
   if (get_loops() > 0) {
