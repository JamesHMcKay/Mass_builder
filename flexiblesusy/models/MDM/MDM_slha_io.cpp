...
// File generated at Fri 1 Sep 2017 15:28:34
...
char const * const MDM_slha_io::drbar_blocks[NUMBER_OF_DRBAR_BLOCKS] =
   { "gauge", "Yu", "Yd", "Ye", "SM", "HMIX" }
;

MDM_slha_io::MDM_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void MDM_slha_io::clear()
{
   slha_io.clear();
}

void MDM_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void MDM_slha_io::set_extpar(const MDM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MDM_slha_io::set_minpar(const MDM_input_parameters& input)
{
 ...
 */
void MDM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MDM_slha_io::set_spinfo(const Problems<MDM_info::NUMBER_OF_PARTICLES>& problems)
{
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MDM_info::model_name)
 ...
 */
void MDM_slha_io::set_mass(const MDM_physical& physical,
                                   bool write_sm_masses)
{
   ...
   mass << "Block MASS\n"
      ...
      << FORMAT_MASS(1000002, LOCALPHYSICAL(MFg), "Fg")
      << FORMAT_MASS(1000003, LOCALPHYSICAL(MFn), "Fn")
   ;
 ...
 */
void MDM_slha_io::set_mixing_matrices(const MDM_physical& physical,
 ...
 */
void MDM_slha_io::write_to(const std::string& output)
{
   if (output == "-")
 ...
 */
double MDM_slha_io::get_parameter_output_scale() const
{
 ...
 */
void MDM_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MDM_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MDM_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MDM_slha_io::fill(MDM_input_parameters& input) const
{
   SLHA_io::Tuple_processor minpar_processor
      = boost::bind(&MDM_slha_io::fill_minpar_tuple, boost::ref(input), _1, _2);
   SLHA_io::Tuple_processor extpar_processor
      = boost::bind(&MDM_slha_io::fill_extpar_tuple, boost::ref(input), _1, _2);
 ...
 */
void MDM_slha_io::fill_drbar_parameters(MDM_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MDM_slha_io::fill(MDM_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MDM_physical physical_hk;
 ...
 */
void MDM_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void MDM_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void MDM_slha_io::fill_minpar_tuple(MDM_input_parameters& input,
...
void MDM_slha_io::fill_extpar_tuple(MDM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MDM_slha_io::fill_physical(MDM_physical& physical) const
{
   {
   ...
   LOCALPHYSICAL(MFg) = slha_io.read_entry("MASS", 1000002);
   LOCALPHYSICAL(MFn) = slha_io.read_entry("MASS", 1000003);
 ...
 */
double MDM_slha_io::read_scale() const
{
   double scale = 0.;
