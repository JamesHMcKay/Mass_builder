...
// File generated at Mon 27 Nov 2017 21:10:27
 ...
 */
double MDM_soft_parameters::calc_beta_mu2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MDM_soft_parameters::calc_beta_mu2_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_mu2 = Re(twoLoop*(-80*Power(g2,4)*AbsSqr(Yc) + 0.0025*mu2*(1671*
      Power(g1,4) + 10*Sqr(g1)*(576*LamH + 50*traceYdAdjYd + 150*traceYeAdjYe +
      170*traceYuAdjYu + 45*Sqr(g2)) + 25*(255*Power(g2,4) + 12*(96*LamH + 5*(
      3*traceYdAdjYd + traceYeAdjYe + 3*traceYuAdjYu))*Sqr(g2) - 8*(48*LamH*(3*
 ...
 */
double MDM_soft_parameters::calc_beta_mu2_three_loop(const Soft_traces& soft_traces) const
{
