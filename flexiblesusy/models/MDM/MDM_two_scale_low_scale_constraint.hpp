...
#ifndef MDM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MDM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MDM_low_scale_constraint.hpp"
...
template<>
class MDM_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   MDM_low_scale_constraint();
   MDM_low_scale_constraint(MDM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MDM_low_scale_constraint();
   virtual void apply();
