...
#ifndef MDM_MASS_EIGENSTATES_H
#define MDM_MASS_EIGENSTATES_H
 ...
 */
class MDM_mass_eigenstates : public MDM_soft_parameters {
public:
   explicit MDM_mass_eigenstates(const MDM_input_parameters& input_ = MDM_input_parameters());
   virtual ~MDM_mass_eigenstates();
   ...
   void set_physical(const MDM_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MDM_physical& get_physical() const;
   MDM_physical& get_physical();
   const Problems<MDM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<MDM_info::NUMBER_OF_PARTICLES>& get_problems();
   ...
   double get_MFg() const { return MFg; }
   ...
   void set_PhaseFg(std::complex<double> PhaseFg_) { PhaseFg = PhaseFg_; }
   std::complex<double> get_PhaseFg() const { return PhaseFg; }
   ...
   void calculate_MFc();
   double get_mass_matrix_Fg() const;
   void calculate_MFg();
   ...
   double CpVPbarFcFcPL() const;
   double CpVPbarFcFcPR() const;
   double CpVPbarFgFgPL() const;
   double CpVPbarFgFgPR() const;
   ...
   double CpVZbarFgFgPL() const;
   double CpVZbarFgFgPR() const;
   ...
   double CpconjVWpbarFcFgPL() const;
   double CpconjVWpbarFcFgPR() const;
   ...
   double CpbarFcconjVWpFgPR() const;
   double CpbarFcconjVWpFgPL() const;
   double CpbarFgVPFgPR() const;
   double CpbarFgVPFgPL() const;
   double CpbarFgVWpFcPR() const;
   double CpbarFgVWpFcPL() const;
   double CpbarFgVZFgPR() const;
   double CpbarFgVZFgPL() const;
   double CpFnbarFcVWpPR() const;
   double CpFnbarFcVWpPL() const;
   ...
   std::complex<double> self_energy_Fg_1(double p ) const;
   std::complex<double> self_energy_Fg_PR(double p ) const;
   std::complex<double> self_energy_Fg_PL(double p ) const;
...
private:
   ...
   MDM_physical physical; ///< contains the pole masses and mixings
   Problems<MDM_info::NUMBER_OF_PARTICLES> problems;
   ...
   std::complex<double> PhaseFg;

};

std::ostream& operator<<(std::ostream&, const MDM_mass_eigenstates&);
