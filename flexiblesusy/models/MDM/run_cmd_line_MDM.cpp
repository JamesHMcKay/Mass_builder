...
int main(int argc, char* argv[])
{
   ...
   const MDM_observables observables(calculate_observables(model, qedqcd, physical_input));

   // SLHA output
   SLHAea::Coll slhaea(MDM_slha_io::fill_slhaea(model, qedqcd, scales, observables));
