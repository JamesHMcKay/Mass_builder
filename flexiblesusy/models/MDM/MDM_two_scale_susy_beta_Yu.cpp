 ...
 */
Eigen::Matrix<double,3,3> MDM_susy_parameters::calc_beta_Yu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MDM_susy_parameters::calc_beta_Yu_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Yu = (twoLoop*(0.0016666666666666668*Yu*(1187*Power(g1,4) + 5*Sqr
      ...
      + 152*Sqr(g3)) - 75*(6*Power(g2,4) - 3*Sqr(g2)*(5*(3*traceYdAdjYd +
 ...
 */
Eigen::Matrix<double,3,3> MDM_susy_parameters::calc_beta_Yu_three_loop(const Susy_traces& susy_traces) const
{
