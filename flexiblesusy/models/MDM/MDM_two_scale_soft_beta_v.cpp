 ...
 */
double MDM_soft_parameters::calc_beta_v_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MDM_soft_parameters::calc_beta_v_two_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MDM_soft_parameters::calc_beta_v_three_loop(const Soft_traces& soft_traces) const
{
