...
// File generated at Fri 1 Sep 2017 15:28:36
...
MDM_initial_guesser<Two_scale>::MDM_initial_guesser(
   MDM<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const MDM_low_scale_constraint<Two_scale>& low_constraint_,
   const MDM_susy_scale_constraint<Two_scale>& susy_constraint_,
   const MDM_high_scale_constraint<Two_scale>& high_constraint_
)
...
{
   assert(model && "MDM_initial_guesser: Error: pointer to model"
          " MDM<Two_scale> must not be zero");
}
 ...
 */
void MDM_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MDM_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void MDM_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void MDM_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MDM_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MDM_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void MDM_initial_guesser<Two_scale>::guess_soft_parameters()
{
