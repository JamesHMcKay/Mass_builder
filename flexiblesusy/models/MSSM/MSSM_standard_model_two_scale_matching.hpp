...
#ifndef MSSM_TWO_SCALE_MATCHING_H
#define MSSM_TWO_SCALE_MATCHING_H
...
template <class T> class MSSM_standard_model_Matching;
...
template<>
class MSSM_standard_model_Matching<Two_scale> : public Matching<Two_scale>
{
public:
   MSSM_standard_model_Matching();

   MSSM_standard_model_Matching(standard_model::StandardModel<Two_scale>*,
                                       MSSM<Two_scale>*,
                                       Constraint<Two_scale>*,
                                       unsigned, unsigned, unsigned);

   virtual ~MSSM_standard_model_Matching();
