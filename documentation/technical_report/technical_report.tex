...
%\begin{align}
%i\Pi^{W^{\pm}}_{\mu\nu}&=-i\frac{\left(-g_{\mu\nu}+k_{\mu}k_{\nu}/m^2_w\right)}{k^2-m_{\text{w}}^2}\\
%i\Pi^{\chi^{\pm}}_{\mu\nu}&=-i\frac{\slashed{k}-m}{k^2-m^2}\\
%i\Pi^{\chi^{\pm\pm}}_{\mu\nu}&=-i\frac{\slashed{k}-m}{k^2-m^2}\\
%i\Pi^{A}_{\mu\nu}&=-i\frac{\left(-g_{\mu\nu}+(\xi-1)k_{\mu}k_{\nu}/k^2\right)}{k^2-m_A^2}\\
%i\Pi^{Z^{\pm}}_{\mu\nu}&=-i\frac{\left(-g_{\mu\nu}+k_{\mu}k_{\nu}/m^2_z\right)}{k^2-m_z^2}\\
%\end{align}
\begin{align}
i\Pi^{W^{\pm}}_{\mu\nu}&=-i\frac{-g_{\mu\nu}}{k^2-m_{\text{w}}^2}\\
...
%The two point propagator is given by
%$$
%\frac{i}{\sp-m+\Sigma}
%$$
%where we split the self energy into two parts, where $\Sigma$ is the self energy.
...
%\begin{align}
%i\Sigma_{\cn}(\slashed{p})&= (-3gi)^2 \int \frac{\d^4k}{(2\pi)^4} \gamma^{\mu}\frac{(\slashed{k}+\slashed{p}+m)\gamma^{\nu}\left(-g_{\mu\nu}+k_{\mu}k_{\nu}/m^2_w\right)}{((p+k)^2-m^2)(k^2-m_{\text{w}}^2)}\label{eqn:cn_loop}
%\end{align}
\begin{align}
...
%\begin{align}
%\Sigma_M=&-2m+\frac{m}{m_{\text{w}}^2}A_0(m^2)+3m B_0(p^2,m^2,m_{\text{w}}^2)\\
%\sp\Sigma_K=&\sp+\sp\frac{A_0(m^2)}{m_{\text{w}}^2}+\sp\left(1+\frac{m^2}{m_{\text{w}}^2}-\frac{p^2}{m_{\text{w}}^2}\right)B_0(p^2,m^2,m_{\text{w}}^2)\\&
%+\sp\left(2+\frac{m^2}{m_{\text{w}}^2}-\frac{p^2}{m_{\text{w}}^2}\right)B_1(p^2,m^2,m_{\text{w}}^2)\end{align}
%such that for the self energy, calculated for $\sp=m$ we obtain
\begin{align}
