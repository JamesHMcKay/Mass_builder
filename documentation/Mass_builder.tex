...
\subsection{\mb}
\mb can be downloaded from \href{https://github.com/JamesHMcKay/Mass_builder.git}{\lstinline{https://github.com/JamesHMcKay/Mass_builder.git}}.  The first step is to run the configuration script
\begin{lstterm}
./scripts/config.sh
\end{lstterm}
which will arrange the files and make some required output directories.

After configuration, build using cmake as follows
\begin{lstterm}
cd build
