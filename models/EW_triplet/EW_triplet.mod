...
Indices -> {},
Mass -> MChi,
PropagatorLabel->ComposedChar["\\chi",Null,"+"],
...
Indices -> {},
Mass -> MChi,
PropagatorLabel->ComposedChar["\\chi",Null,"0"],
PropagatorType -> Straight,
PropagatorArrow -> None},
...
C[-V[3], V[1], V[1], V[3]] == {{I*g2^2*STW^2}, {I*g2^2*STW^2}, {(-2*I)*g2^2*STW^2}},
 ...
 C[-F[1], F[1], V[1]] == {{(-I)*g2*STW,0}, {(-I)*g2*STW,(-I)*dg2*STW}},
 C[-F[1], F[1], V[2]] == {{(-I)*CTW*g2,0}, {(-I)*CTW*g2,(-I)*dg2*CTW}},
