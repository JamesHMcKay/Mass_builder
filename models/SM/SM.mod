...
This file introduces the following symbols:
	...
	ME, FAMass["Muon"], ML:	lepton masses (e, mu, tau)
...
M$CouplingMatrices = {
  ...
  C[ U[2], -U[2] ] == -I *
    { {0, -dZZZ1/2 + dUZZ1},
      {0, FAGaugeXi[Z] (MZ^2 (-dZG01/2 + dUZZ1) + dMZsq1/2) } },
  ...
  C[ U[1], -U[2] ] == -I *
    { {0, -dZZA1/2 + dUZA1},
      {0, FAGaugeXi[Z] MZ^2 dUZA1} },
  
  C[ U[3], -U[3] ] == -I *
    { {0, -dZW1/2 + dUW1},
      {0, FAGaugeXi[W] (MW^2 (-dZGp1/2 + dUW1) + dMWsq1/2) } },
  C[ U[4], -U[4] ] == -I *
    { {0, -dZW1/2 + dUW1},
      {0, FAGaugeXi[W] (MW^2 (-dZGp1/2 + dUW1) + dMWsq1/2) } },
  ...
  C[ -U[1], U[4], V[3] ] == -I EL *
    { {1, dZe1 + dZW1/2 - dZAA1/2 + dUW1 + CW/SW dZAZ1/2},
      {0, 0} },
	(* S-U-U:  G(+) . 1 *)
  C[ S[1], -U[2], U[1] ] == -I EL MZ FAGaugeXi[Z]/(2 SW CW) *
    { {0, dUZA1} },
  C[ S[1], -U[2], U[2] ] == -I EL MZ FAGaugeXi[Z]/(2 SW CW) *
    { {1, dZe1 + (SW^2 - CW^2)/(CW^2 SW) dSW1 + dZH1/2 - dZG01/2 + dUZZ1} },
  C[ S[1], -U[3], U[3] ] == -I EL MW FAGaugeXi[W]/(2 SW) *
    { {1, dZe1 - dSW1/SW + dZH1/2 - dZGp1/2 + dUW1} },
  C[ S[1], -U[4], U[4] ] == -I EL MW FAGaugeXi[W]/(2 SW) *
    { {1, dZe1 - dSW1/SW + dZH1/2 - dZGp1/2 + dUW1} },
  C[ S[2], -U[4], U[4] ] == EL MW FAGaugeXi[W]/(2 SW) *
    { {1, dZe1 - dSW1/SW + dZG01/2 - dZGp1/2 + dUW1} },
  C[ S[2], -U[3], U[3] ] == -EL MW FAGaugeXi[W]/(2 SW) *
    { {1, dZe1 - dSW1/SW + dZG01/2 - dZGp1/2 + dUW1} },
  C[ -S[3], -U[2], U[3] ] == I EL MZ FAGaugeXi[Z]/(2 SW) *
    { {1, dZe1 - dSW1/SW + dZGp1/2 - dZG01/2 + dUW1} },
  C[ S[3], -U[2], U[4] ] == I EL MZ FAGaugeXi[Z]/(2 SW) *
    { {1, dZe1 - dSW1/SW + dZGp1/2 - dZG01/2 + dUW1} },
  C[ -S[3], -U[4], U[2] ] == I EL (SW^2 - CW^2) MW FAGaugeXi[W]/(2 CW SW) *
    { {1, dZe1 + dSW1/((SW^2 - CW^2) CW^2 SW) + dUZZ1 +
        (2 SW CW)/(SW^2 - CW^2) dUAZ1} },
  C[ S[3], -U[3], U[2] ] == I EL (SW^2 - CW^2) MW FAGaugeXi[W]/(2 CW SW) *
    { {1, dZe1 + dSW1/((SW^2 - CW^2) CW^2 SW) + dUZZ1 +
        (2 SW CW)/(SW^2 - CW^2) dUAZ1} },
  C[ -S[3], -U[4], U[1] ] == I EL MW FAGaugeXi[W] *
    { {1, dZe1 + dUAA1 + (SW^2 - CW^2)/(2 SW CW) dUZA1} },
  C[ S[3], -U[3], U[1] ] == I EL MW FAGaugeXi[W] *
    { {1, dZe1 + dUAA1 + (SW^2 - CW^2)/(2 SW CW) dUZA1} }
}
M$LastModelRules = {}
