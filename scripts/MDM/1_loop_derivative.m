...
Get[FileNameJoin[{path, 
    "/models/itMSSM///output/math_data_F11_g1_1_1.mx"}]];
F11SE = F11SE + SelfEnergyFinite*kappa;

Get[FileNameJoin[{path, 
    "/models/itMSSM///output/math_data_F11_g1_2_1.mx"}]];
F11SE = F11SE + SelfEnergyFinite*kappa;

Get[FileNameJoin[{path, 
    "/models/itMSSM///output/math_data_F11_g1_3_1.mx"}]];
F11SE = F11SE + SelfEnergyFinite*kappa;

F11SEdiv = makeFiniteAmplitude[F11SE, -1, D];

Get[FileNameJoin[{path, 
    "/models/itMSSM///output/math_data_F11_g1_1_1c.mx"}]];
...
Get[FileNameJoin[{path, 
    "/models/itMSSM///output/math_data_F12_g1_1_1.mx"}]];
F12SE = F12SE + SelfEnergyFinite*kappa;

Get[FileNameJoin[{path, 
    "/models/itMSSM///output/math_data_F12_g1_2_1.mx"}]];
F12SE = F12SE + SelfEnergyFinite*kappa;

Get[FileNameJoin[{path, 
    "/models/itMSSM///output/math_data_F12_g1_3_1.mx"}]];
F12SE = F12SE + SelfEnergyFinite*kappa;

F12SEdiv = makeFiniteAmplitude[F12SE, -1, D];
Get[FileNameJoin[{path, 
    "/models/itMSSM///output/math_data_F12_g1_1_1c.mx"}]];
...
Get[FileNameJoin[{path, "/models/itMSSM///output/math_data_F12_g1_1_1.mx"}]];
F12SE = F12SE + SelfEnergyFinite*kappa;

Get[FileNameJoin[{path, "/models/itMSSM///output/math_data_F12_g1_2_1.mx"}]];
F12SE = F12SE + SelfEnergyFinite*kappa;

Get[FileNameJoin[{path, "/models/itMSSM///output/math_data_F12_g1_3_1.mx"}]];
F12SE = F12SE + SelfEnergyFinite*kappa;

Get[FileNameJoin[{path, "/models/itMSSM///output/math_data_F12_g1_1_1c.mx"}]];
F12SE = F12SE + SelfEnergyFinite*kappa;
