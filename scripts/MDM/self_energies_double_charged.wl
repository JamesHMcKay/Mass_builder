...
SetOptions[DiracSlash, Dimension -> D, FeynCalcInternal -> True]; 
 ...
 alldiags = InsertFields[t12, {F[6]} -> {F[6]},InsertionLevel -> {Particles}, GenericModel -> Lorentz,Restrictions -> {},Model -> "/Users/jamesmckay/Documents/Programs/Mass_builder/models/MDM/MDM"]; 
...
SelfEnergyFinite = expandBasisIntegrals[SE, masses, massesExpand, MassBuilderA,MassBuilderB, MassBuilderJ, MassBuilderK, MassBuilderT, MassBuilderV, MassBuilderF]; 
 DumpSave["/Users/jamesmckay/Documents/Programs/Mass_builder/models/MDM/output/math_data_F6_{1,2,3}_1.mx", SelfEnergyFinite]; 
