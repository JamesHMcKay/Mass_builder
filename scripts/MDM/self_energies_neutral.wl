...
SetOptions[DiracSlash, Dimension -> D, FeynCalcInternal -> True]; 
 ...
 alldiags = InsertFields[t12, {F[7]} -> {F[7]},InsertionLevel -> {Particles}, GenericModel -> Lorentz,Restrictions -> {},Model -> "/Users/jamesmckay/Documents/Programs/Mass_builder/models/MDM/MDM"]; 
