...
SetOptions[DiracSlash, Dimension -> D, FeynCalcInternal -> True]; 
 ...
 alldiags = InsertFields[t12, {F[11,{1}]} -> {F[11,{1}]},InsertionLevel -> {Particles}, GenericModel -> Lorentz,Restrictions -> {WinoLimit,WinoCouplings},Model -> "/Users/jamesmckay/Documents/Programs/Mass_builder/models/MSSM/MSSM"]; 
...
Coefficient[C2AC*I/.e->g*sw,p,1]
Coefficient[C2AC*I,p,0]


Coefficient[C2Aw*I/.e->g*sw ,p,1]
Coefficient[C2Aw*I ,p,0]


Coefficient[C2BCw*I/.e->g*sw ,p,1]
Coefficient[C2BCw*I/.e->g*sw ,p,0]


Coefficient[difference2/.e->g*sw,p,1]
Coefficient[difference2/.e->g*sw,p,0]
