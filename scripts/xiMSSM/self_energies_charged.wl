...
SetOptions[DiracSlash, Dimension -> D, FeynCalcInternal -> True]; 
 ...
 alldiags = InsertFields[t12, {F[12,{1}]} -> {F[12,{1}]},InsertionLevel -> {Particles}, GenericModel -> Lorentz,Restrictions -> {WinoLimit,WinoCouplings},Model -> "/Users/jamesmckay/Documents/Programs/Mass_builder/models/xiMSSM/xiMSSM"]; 
...
masses = List[MChi,mw,mz,null,mw*Xi,mz*Xi]; 
 massesExpand = List[1,1,1,0,1,1]; 
...
SelfEnergyFinite = expandBasisIntegrals[SE, masses, massesExpand, MassBuilderA,MassBuilderB, MassBuilderJ, MassBuilderK, MassBuilderT, MassBuilderV, MassBuilderF]; 
 DumpSave["/Users/jamesmckay/Documents/Programs/Mass_builder/models/xiMSSM/output/math_data_F12_g1_{1,2,3}_1.mx", SelfEnergyFinite]; 
...
AppendTo[$Path, "/Users/jamesmckay/Documents/Programs/Mass_builder/output/"]; 
...
FullSimplify[I*CAc/.e->g*sw]


FullSimplify[I*CAw/.e->g*sw ]


FullSimplify[I*CAwx/.e->g*sw ]


FullSimplify[I*CAz /.e->g*sw]


FullSimplify[I*CAzx/.e->g*sw]


FullSimplify[Coefficient[I*CBcn/.e->g*sw ,p,1]]
FullSimplify[Coefficient[FullSimplify[I*CBcn/.e->g*sw ],p,0]]


FullSimplify[Coefficient[I*CBcw/.e->g*sw ,p,1]]
FullSimplify[Coefficient[I*CBcw/.e->g*sw ,p,0]]


FullSimplify[Coefficient[I*CBcwx/.e->g*sw,p,1]]
FullSimplify[Coefficient[I*CBcwx/.e->g*sw,p,0]]


FullSimplify[Coefficient[I*CBcz/.e->g*sw,p,1]]
FullSimplify[Coefficient[I*CBcz/.e->g*sw,p,0]]


FullSimplify[Coefficient[I*CBczx/.e->g*sw,p,1]]
FullSimplify[Coefficient[I*CBczx/.e->g*sw,p,0]]


FullSimplify[Coefficient[diff/.e->g*sw,p,1]]
FullSimplify[Coefficient[diff/.e->g*sw,p,0]]
