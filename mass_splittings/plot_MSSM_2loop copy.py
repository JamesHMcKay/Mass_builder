...
ax.fill_between(xnew1, lower_1loop_smooth,upper_1loop_smooth,color='green',zorder=500,linewidth=2,label=r'$\mathrm{One\!-\!loop}$')	
...
ax.fill_between(xnew1, lower_2loop_smooth,upper_2loop_smooth,color='red',alpha=0.3,zorder=100,linewidth=2,label=r'$\mathrm{Two\!-\!loop}$')	
