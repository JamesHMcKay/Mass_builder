...
plt.plot(x1,z1,'-',color=color1,linewidth=1.2) #
plt.plot(x2,z2,'-',color=color2,linewidth=1.2) #
plt.plot(x3,z3,'-',color=color3,linewidth=1.2) #
plt.plot(x4,z4,'-',color=color4,linewidth=1.2) #
plt.plot(x5,z5,'-',color=color5,linewidth=1.2) #
...
plt.plot(x2,ylower,'-',color=color1,label="$Q=2 m_t$") #
plt.plot(x2,ymid,'-',color=color2,label="$Q=m_t/2$")
plt.plot(x2,yupper1,'-',color=color3,label="$Q=\hat{M}/2$")#
plt.plot(x2,yupper2,'-',color=color4,label="$Q= \hat{M}$")
plt.plot(x2,yupper3,'-',color=color5,label="$Q=2 \hat{M}$")
