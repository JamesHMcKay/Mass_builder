...
plt.plot(x,ylower/x,'-',color=color1,label="$Q=2 m_t$",linewidth=1.2) #
plt.plot(x,ymid/x,'-',color=color2,label="$Q=0.5 m_t$",linewidth=1.2) #
plt.plot(x,yupper1/x,'-',color=color3,label="$Q=0.5 M$",linewidth=1.2) #
plt.plot(x,yupper2/x,'-',color=color4,label="$Q= M$",linewidth=1.2) #
plt.plot(x,yupper3/x,'-',color=color5,label="$Q=2 M$",linewidth=1.2) #
